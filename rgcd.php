...
if(isset($_POST['predict']))
{
	...
	$branch=$_POST['branchname'];
      $op="SELECT * from diploma where ('$rank'<=rank and gender='$gender' and caste='$caste' and district='$district')";
       if($op)
      {
	$query="SELECT * from diploma where ('$rank'<=rank and gender='$gender' and caste='$caste' and district='$district') order by rank";
