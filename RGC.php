...
<?php
error_reporting(0);
$connection=mysqli_connect('localhost','root','') or die ("<html><script language='JavaScript'>alert('Unable to connect to database! Please try again later.'),history.go(-1)</script></html>");
...
if(isset($_POST['predict']))
{
	...
	$query="SELECT * from diploma where ('$rank'<=rank and gender='$gender' and caste='$caste')  order by rank";
