...
if(isset($_POST['predict']))
{
	...
	$query="SELECT * from btech1 where ('$rank'<=rank AND gender='$gender' AND caste='$caste' AND location='$district' AND branchname='$branch') order by rank";
    $query_run=mysqli_query($connection,$query);
	if($query_run!=0){
		echo"$rank,$branch,$district,$caste,$gender";
	}
