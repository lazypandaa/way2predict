...
if(isset($_POST['predict']))
{
	...
	$query="SELECT * from btech where ('$rank'<=rank AND gender='$gender' AND caste='$caste' AND location='$district' AND branchname='$branch' AND region='$region' AND collegetype='$collegetype') order by rank";
