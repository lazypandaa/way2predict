...
$query="SELECT * from diploma where ('$rank'<=rank AND gender='$gender' AND caste='$caste' AND district='$district' AND branchname='$branch') order by rank";
